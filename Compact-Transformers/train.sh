...
for s in 1 2 3
do
	python main.py --depth 6 --channel 48 --heads 3 --gpu 1 --lr 0.003 --model ViT --tag vit_base --seed ${s}
	# python main.py --depth 6 --channel 64 --heads 4 --gpu 0 --lr 0.003 --model ViT --tag vit_base --seed ${s}
	# python main.py --depth 6 --channel 80 --heads 5 --gpu 0 --lr 0.003 --model ViT --tag vit_base --seed ${s}
	python main.py --depth 6 --channel 96 --heads 6 --gpu 1 --lr 0.003 --model ViT --tag vit_base --seed ${s}
done
