...
do
	for d in 1 4
	do
		python train.py --dataset_dir /workspace/dataset --gpu 0 --lr 0.003 --model P-ViT-Node --seed ${s} --depth ${d} --channel 64 --heads 4 --tag P_ViT_Node_Baseline_quater_2 --pp 4
	done
	
	# for d in 2 3
	# do
	# 	python train.py --dataset_dir /workspace/dataset --gpu 1 --lr 0.003 --model P-ViT-Node --seed ${s} --depth ${d} --channel 64 --heads 4 --tag P_ViT_Node_Baseline_quater_2 --pp 4
	# done
