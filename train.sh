...
for s in 3 4 5
do
#	python main.py --depth 9 --heads 12 --channel 192 --lr 0.003 --gpu 0 --model vit --tag vit_BASE --seed ${s} --dataset T-IMNET --ls --aa --mu --sd 0.1 --ra 3 --cm --re 0.25
	python main.py --depth 9 --heads 12 --channel 192 --lr 0.003 --gpu 1 --model g-vit --tag vit_masking --seed ${s} --dataset T-IMNET --ls --aa --mu --sd 0.1 --ra 3 --cm --re 0.25
