...
class Model(nn.Module):
    def __init__(self, *, img_size, patch_size, num_classes, dim=192, depth=9, heads=12, mlp_dim_ratio=2, pool = 'cls', channels = 3, dim_head = 16, dropout = 0., emb_dropout = 0., stochastic_depth=0.):
        super().__init__()
