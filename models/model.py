...
def PiT_Ti_cifar(EB=False, IB=False):
    return PiT(in_height=32, in_width=32, num_nodes=16*16, inter_channels=16, num_blocks=[1, 3, 1], heads=2, EB=EB, IB=IB)


def PiT_XS_cifar(EB=False, IB=False):
    return PiT(in_height=32, in_width=32, num_nodes=16*16, inter_channels=20, num_blocks=[1, 3, 1], heads=2, EB=EB, IB=IB)


def PiT_S_cifar(EB=False, IB=False):
    return PiT(in_height=32, in_width=32, num_nodes=16*16, inter_channels=30, num_blocks=[1, 3, 1], heads=3, EB=EB, IB=IB)
