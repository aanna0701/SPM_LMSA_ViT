...
def main(args):
    ...
    for weight in weights_paths:
        ...
        entropy(val_loader, model, weight, args)
    
    
def entropy(val_loader, model, weight, args):
...
if __name__ == '__main__':
    ...
    log_dir = os.path.join('entropy_results', args.tag,'rank.csv')
    os.makedirs(os.path.join('entropy_results', args.tag), exist_ok=True)
