...
for s in 2 3
do
#	python main.py --depth 6 --channel 48 --heads 3 --gpu 1 --lr 0.003 --model g-vit --tag g-vit_base_scale --seed ${s}
	python main.py --depth 6 --channel 64 --heads 4 --gpu 0 --lr 0.003 --model g-vit --tag g-vit_base_scale --seed ${s}
	python main.py --depth 6 --channel 80 --heads 5 --gpu 0 --lr 0.003 --model g-vit --tag g-vit_base_scale --seed ${s}
#	python main.py --depth 6 --channel 96 --heads 6 --gpu 1 --lr 0.003 --model g-vit --tag g-vit_base_scale --seed ${s}
done
