    ...
    def forward(self, x):
        ...
        for i in range(len(self.NLB_list)):
            if self.NLB_list[i].name == 'NLB':
                if latent.size(1) == 16 :
                    if self.EB:
                        latent = self.NLB_list[i](latent, self.EB_list[j], self.bn3)
                        j += 1
                    else:
                        latent = self.NLB_list[i](latent)
                    ...
                    if self.EB:
                        latent = self.NLB_list[i](latent, self.EB_list[j], self.bn2)
                        j += 1
                    else:
                        latent = self.NLB_list[i](latent)
                    ...
                    if self.EB:
                        latent = self.NLB_list[i](latent, self.EB_list[j], self.bn1)
                        j += 1
                    else:
                        latent = self.NLB_list[i](latent)
            else:
